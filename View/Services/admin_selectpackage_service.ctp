	...
	<?php  echo $this->Form->create('SalonService',array('id'=>'packageserviceSelectForm'),'novalidate');
		echo $this->Form->hidden('Package.id',array('value'=>''));
	?>
		...
		<div>
				...
				?>
					...
					<?php echo $this->Form->checkbox('salon_service_id.',array('value'=>$theChId,'label'=>false,'div'=>false,'class'=>'rootservice','style'=>'display:none;')); ?>
								...
								foreach($theChildren['children'] as $finalChild){
								    ...
								    echo $this->Form->checkbox('salon_service_id.',array('id'=>'service_id_li'.$finalChild['SalonService']['id'],'value'=>$finalChild['SalonService']['id'],'div'=>false,'checked'=>$this->Common->checkPackageServiceSelected($finalChild['SalonService']['id'],$ID),'class'=>'styled subCheck'));
          ...
          <div class="modal-footer pdng20">
          	<?php echo $this->Form->button('Save',array('type'=>'submit','class'=>'btn btn-primary packageService','label'=>false,'div'=>false));?>
