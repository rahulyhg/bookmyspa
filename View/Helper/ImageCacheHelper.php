...
class ImageCacheHelper extends AppHelper {
    ...
    public function __construct($options = array()) {
        ...
        $defaults = array(
            ...
            "cached_image_directory" => WWW_ROOT . "/cache",
            "cached_image_url" => "",
            "cached_directory_version" => ""
        );
        // $defaults = $options;
        $this->options = (object)$defaults;
    ...
    public function cache($image, $version = "") {
        ...
        if ($this->cached_file_exists()) {
           ...
           echo $this->src_filesize;
           echo " ";
           echo $this->cached_filesize;;
           exit;
