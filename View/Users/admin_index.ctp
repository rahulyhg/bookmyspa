	...
	<div class="col-lg-2">
	    <?php $user_types = array('' => 'All', '0' => 'Visitor', '1' => 'Publisher');
 ...
 <?php
                        ...
                        <tr <?php echo $class;?>>
                           ...
                           <?php   $status = $getData['User']['status'];
                            ...
                            <td ><?php echo ($getData['Country']['name']) ? $getData['Country']['name'] : 'N/A'; ?></td>
			    <td ><?php
				...
				echo $this->Html->link($this->Html->image("admin/lock.png", array("alt" => "User Detail","title" => "User Revenue")),"/admin/users/set_revenue/".base64_encode($getData['User']['id']),array('escape' =>false,'class' => ''));                                 
                            ?>
