        ...
        var redirectUrl  = '';
            ...
            if (release == 1) {
                redirectUrl = '/users/comments_scroll/' + wallcount+'/<?php echo $userDetail['User']['id']; ?>' ;
                $('.gifIndicator').show();
                        	...
                        	<section class="col-lg-12">
                            	...
                            	<section class="user-profile-block">
                                	<section class="user-profile-row">
                                    	<section class="user-profile-pic">
                                               ...
                                               if(filter_var($userDetail['User']['avatar_image'], FILTER_VALIDATE_URL)){
                                                echo   $this->Html->image($userDetail['User']['avatar_image'], array('alt' => '',"width"=>"103","height"=>"103", 'url' => array('controller' => 'users', 'action' => 'profile_post',$userDetail['User']['id'] )));
                                                }else{
                                                echo $this->Html->image('/img/avatar/'.$userDetail['User']['avatar_image'], array('alt' => '', "width"=>"103", "height"=>"103", 'url' => array('controller' => 'users', 'action' => 'profile_post',$userDetail['User']['id'] )));
                                                }
                                                }else{
                                                echo $this->Html->image('/img/avatar/no_image.png', array('alt' => '', "width"=>"103" ,"height"=>"103", 'url' => array('controller' => 'users', 'action' => 'profile_post',$userDetail['User']['id'] )));
                                                } ?>
                                        </section>
                                    ...
                                    <section class="user-profile-btn clearfix">
                                    	<ul>
                                        	<li>
                                                <a class="button btn" href="<?php echo BASE_URL.'users/profile_post/'.$userDetail['User']['id']; ?>">
 ...
 Comments <span><?php echo $commentCnt; ?></span>
                                ...
                                <!--user-profile-comment-start-->
									...
									if(filter_var($theComment['User']['avatar_image'], FILTER_VALIDATE_URL)){
                                                                    echo $this->Html->image($theComment['User']['avatar_image'], array('alt' => '', 'url' => array('controller' => 'users', 'action' => 'profile_post',$userDetail['User']['id'] )));
                                                                        }else{
                                                                        echo $this->Html->image('/img/avatar/'.$theComment['User']['avatar_image'], array('alt' => '', 'url' => array('controller' => 'users', 'action' => 'profile_post',$userDetail['User']['id'] )));
                                                                        }
									}else{
						    			echo $this->Html->image('/img/avatar/no_image.png', array('alt' => '', 'url' => array('controller' => 'users', 'action' => 'profile_post',$userDetail['User']['id'] )));
                                                                        } ?>
                                                               </span>
                                                                <span class="post-time"><a href="<?php echo BASE_URL.'users/profile_post/'.$theComment['User']['id']; ?>"><strong><?php echo ucfirst($theComment['User']['first_name']." ".$theComment['User']['last_name']);?></strong></a> Commented on :</span>
                                                            ...
                                                            <section class="col-sm-3 postrow">
                                                                <section class="comment-date">
                                                                 ...
                                                                 <?php  echo $this->Common->getTimeDifference($theComment['PostComment']['created']);?>
                                                                </section>
                                                            </section>
                                                        </section>
									...
									echo '<img src="'.$image_name.'"onmouseover=this.src="/img/photos/original/'.$filename.'" onmouseout=this.src="'.$image_name.'" / >';
												} ?>
...
//                                                                                    } ?>
                                    ...
                                    <section  style="display: none"class="row gifIndicator text-center">
