    <?php  
        ...
        <div class="row padding_btm_20">
            ...
            <div class="col-lg-4">    
                <!--<div class="addbutton">                
                    <?php //echo $this->Html->link('Add New Content','/admin/contents/addedit',array('class' => 'icon-file-alt','title' => 'Add Page'));?>
                </div>
                -->
            </div>
        </div>
                       ...
                       ?>
                        ...
                        <?php   
                          ...
                          <td align="center"><?php echo date('M j, Y',strtotime($getData['Content']['created']));?></td>                            
                            <td align="center">
                            <?php
                               // echo $this->Html->link($this->Html->image("admin/edit.png", array("alt" => "Edit","title" => "Edit")),"/admin/contents/addedit/".base64_encode($getData['Content']['id']),array('escape' =>false));
                                echo $this->Html->link($this->Html->image("admin/delete.png", array("alt" => "Edit","title" => "Delete")),"/admin/contents/delete/".base64_encode($getData['Content']['id']).'/',array('escape' =>false),"Are you sure you wish to delete this content?");
