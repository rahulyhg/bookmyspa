...
.modal.fade .modal-dialog{border-radius:6px;}
    ...
    <?php echo $this->Html->script('bootbox.js'); ?>
     ...
     <div class="modal-dialog login marketing">
        <div class="modal-content">
          ...
          <div class="modal-body clearfix">
            ...
            <div class="voucher-box mrgn-rgt0">
                ...
                <h2>Add Customized Service</h2>
               <?php echo $this->Form->button('Add New',array('class'=>'purple-btn editTreat','label'=>false, 'data-cat'=>$cat_parent_id, "data-id"=>$id, "data-parent-id"=>$parent_id,'div'=>false));?>
            </div>
          </div>
        </div>
      </div>
