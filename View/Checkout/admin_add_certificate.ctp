...
<div class="modal-dialog modal-lg vendor-setting">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                ...
                                <?php $customer_name = $this->Common->get_user_name($customer_id);
                                    echo $this->Form->input('GiftCertificate.sender_name', array('value' =>$customer_name,'div' => 'false', 'class' => 'required form-control', 'label' => false,'disabled' => true));?>   
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-12">
