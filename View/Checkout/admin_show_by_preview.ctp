<div class="modal-dialog modal-lg new_add_preview">
    <div class="modal-content">
        ...
        <div class="modal-body clearfix">
            <div class="preview-box1" id="printingDiv">
                <?php echo $this->Html->image('/'.@$image_path , array('id'=>'image_down'));?>
            </div>
        </div>
        <div class="modal-footer">                               
        <?php
            echo $this->Form->button('Cancel', array('data-dismiss' => 'modal','type' => 'button', 'label' => false, 'div' => false,'class' => 'purple-btn closeModal'));
            echo $this->Form->button('Save', array('type' => 'button', 'label' => false, 'div' => false,
...
$('.save-gift').click(function(){
    ...
    var imageSaveURL = "<?php echo $this->Html->url(array('controller' => 'Checkout', 'action' => 'save_image', 'admin' => false)); ?>";
