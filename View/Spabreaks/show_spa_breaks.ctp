...
<div class="salonData clearfix">
 ...
 <?php echo $this->element('frontend/Place/booking_spabreak'); ?></div>
...
<script>
	...
	var d = new Date();
        var n = d.getDay();
        var bookSrvcURL = '<?php echo $this->Html->url(array('controller'=>'place','action'=>'showSpaBreak'));?>'+'/'+serviceId;
...
//		});
   ...
   $(document).ready(function(){
	...
	$('.forBooking').on('click',function(e){
            e.preventDefault();
	    var theObj = $(this);
