...
<div class="salonData clearfix">
	...
	<div class="container">
	    ...
	    <li role="presentation">
	        <?php echo $this->Js->link(__('My Appointments',true),'/Myaccount/appointments',array('update' => '#upadate_tab'));?>
	    </li>            <li role="presentation">
	        <?php echo $this->Js->link(__('Past Appointments',true),'/Myaccount/appointments/past',array('update' => '#upadate_tab'));?>
	    </li>
          </ul>
	    ...
	    <?php } ?>
            ...
            <div class="profile-btns">
                <button type="button" class="gray-btn">Close</button>
        	</div>
          </div>
