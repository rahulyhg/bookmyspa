    ...
    <script src="https://raw.githubusercontent.com/VanFanelia/jQuery-contextMenu/970012afbc01dedae7f939e572a2798a93337351/src/jquery.contextMenu.js" type="text/javascript"></script>
...
$.contextMenu({
    ...
    callback: function (key, options) {
        ...
        var uid = $(this).attr("data-uid");
        if (key == "add") {
            var dataItem = dataSource.getByUid(row.data("uid"));
            scheduler.addEvent(dataItem);
        }
    },
    items: {
