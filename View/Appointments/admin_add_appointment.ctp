<?php
//echo date('h: A',$open_close_hours[0]); die;
//date_default_timezone_set("UTC");
//echo date('h:i A',$open_close_hours[0]);[0]; die;
//echo date('h:i A',$open_close_hours[0]." UTC"); die;
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                 <label class="control-label"><b><p>Provider - <?php echo $staffname; ?></p></b></label>
											...
											<div class="form-group">
                                                <?php echo $this->Form->input('Appointment.closing_hours',array( 'class'=>'form-control','type'=>'hidden','label'=>false,'value'=>$open_close_hours[1])); ?>
											</div>
											<div class="form-group">
										...
										<div class="col-sm-5 pdng0">
											<div class="form-group">
											<?php
												if(isset($edit_appointment) && $edit_appointment['Appointment']['appointment_comment']!=''){
											...
											<?php }
											elseif(isset($editType) && $editType=='' && isset($edit_appointment) && $edit_appointment['Appointment']['appointment_repeat_type']!=0){ ?>
											<div class="form-group">
												<?php echo $this->element('admin/Appointment/appointment_repeat'); ?>
											</div>
                                        ...
                                        <div class="modal-footer pdng20">
                                            ...
                                            <?php } ?>
                                            <?php echo $this->Form->button('Save',array('type'=>'submit','class'=>'btn btn-primary submitAppointment','label'=>false,'div'=>false));?>
