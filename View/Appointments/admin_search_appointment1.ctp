                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->input('Appointment.user_id',array('div'=>false,'options'=>$userList,'empty'=>'Please Select Customer','label'=>false,'class'=>'select2-me userSelect nopadding form-control bod-non','required','validationMessage'=>'Please Select Customer','selected'=>$selected));?>
                                    </div>
                                </div>
                            </div>
