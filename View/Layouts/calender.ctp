...
<html>
    ...
    <?php
   // pr(date('d-m-Y',1449792000)); 
   // pr(date('d-m-Y',1459368000));
	...
	/*********************For phone validation **************************/	
            $(document).on("keyup","input[name='data[Contact][cell_phone]'],input[name='data[Contact][night_phone]'],input[name='data[Contact][day_phone]'], .phone_err" ,function(){
