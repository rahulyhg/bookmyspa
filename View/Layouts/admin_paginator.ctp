...
<head>
	<?php echo $this->Html->charset(); ?>
		...
		<?php //echo $this->Html->meta('icon');
			...
			<?php echo $this->Html->css('admin/style_not_minified'); ?>
			...
			<?php echo $this->Html->css('admin/color/red'); ?>
			<?php echo $this->Html->css('admin/color/orange'); ?>
			<?php echo $this->Html->css('admin/color/green'); ?>
			<?php echo $this->Html->css('admin/color/brown'); ?>
			<?php echo $this->Html->css('admin/color/blue'); ?>
			<?php echo $this->Html->css('admin/color/lime'); ?>
			<?php echo $this->Html->css('admin/color/teal'); ?>
			<?php echo $this->Html->css('admin/color/purple'); ?>
			<?php echo $this->Html->css('admin/color/pink'); ?>
			<?php echo $this->Html->css('admin/color/magenta'); ?>
			<?php echo $this->Html->css('admin/color/grey'); ?>
			<?php echo $this->Html->css('admin/color/darkblue'); ?>
			<?php echo $this->Html->css('admin/color/lightred'); ?>
			<?php echo $this->Html->css('admin/color/lightgrey'); ?>
			<?php echo $this->Html->css('admin/color/satblue'); ?>
			<?php echo $this->Html->css('admin/color/satgreen'); ?>
...
<div class="modal fade" id="commonVendorModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <!-- <div class="loader-container ">
		<div class="inner-loader"><img src="/img/loader.GIF" alt="" title=""></div>
	</div>-->
