...
<?php if(isset($ServicePricingOptions) && count($ServicePricingOptions)>0){
       ...
       foreach($ServicePricingOptions as $ServicePricingOptions){
            ...
            if($i==1){
                    $checked='checked'; $required='required'; $pricemessage='Please enter price';
        ...
        <div id='PriceDurationBlock' class="col-sm-12">
            <div class='form-group col-sm-1'>
                <input type='radio' checked='<?php echo $checked?>' name='data[Appointment][check]' id='OptionsSelectPlan_<?php echo $i; ?>' value="<?php echo $i; ?>" onclick='add_validation(this.value);'>
