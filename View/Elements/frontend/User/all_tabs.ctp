<div class="main-nav clearfix inner-appt">
    ...
    <nav class="collapse" id="bs-example-navbar-collapse-3">
        ...
        <?php
	      ...
	      <?php $li_class = '';
		if($this->params['controller'] == 'users' || $this->params['controller'] == 'Users' && $this->params['action'] == 'spabreaks'){
		      $li_class = 'active';
		}?>
            <li role="presentation" class="<?php echo $li_class;?>">
	     ...
	     <li role="presentation" class="<?php echo $li_class;?>">
            ...
            <?php
            $li_class = '';
            if($this->params['controller'] == 'users' || $this->params['controller'] == 'Users' && $this->params['action'] == 'AccountManagement'){
                  $li_class = 'active';
            }
            ?>
             <li role="presentation" class="<?php echo $li_class;?>">
