...
<tbody>
    <?php
    if(!empty($businessUsers['multiLocation'])){
        foreach($businessUsers['multiLocation'] as $key=>$user){
            ...
            <tr data-id="<?php echo $user['User']['id']; ?>" >
              ...
              <!--  <td><?php
                ...
                <td align="center">
                    ...
                    <?php // ?>
                    &nbsp;&nbsp;
                    <?php echo $this->Html->link('<i class="icon-trash"></i>', "javascript:void(0)", array('data-salon_type'=>'frenchise','title'=>'Delete','data-id'=>base64_encode($user['User']['id']),'class'=>'delete','escape'=>false)); ?>
                    &nbsp;&nbsp;
                    <?php 
