...
<div class="collapse navbar-collapse col-sm-6 nav_box" id="bs-example-navbar-collapse-1">
    <ul class="nav navbar-nav admin">
        ...
        <?php } ?>
        <?php if(isset($auth_user) && in_array($auth_user['User']['type'],array(3,4,5))){
            $Id=base64_encode("top");
            ?>
        <li <?php if($activeTMenu == 'checkout'){ echo 'class="active"'; } ?> >
        <?php echo $this->Html->link('<span>Checkout</span>',array('controller'=>'Checkout','action'=>'appointment','admin'=>true,$Id),array('escape'=>false)); ?>
        </li>
        <?php } ?>
    ...
    <?php }?> 
                 ...
                 <li class="dropdown-submenu <?php if(in_array($activeTMenu,array('giftCertificatelist','gftImageManage'))){ echo 'active'; } ?>">
                    ...
                    <ul class="dropdown-menu">
                        <li <?php if($activeTMenu == 'giftCertificatelist'){ echo 'class="active"'; } ?> >
                         ...
                         <li <?php if($activeTMenu == 'gftImageCategory'){ echo 'class="active"'; } ?> >
                            <?php echo $this->Html->link('<span>Category</span>',array('controller'=>'GiftImages','action'=>'category_management','admin'=>true),array('escape'=>false)); ?>
                        </li>
        ...
        <?php } ?>
        <?php if(isset($auth_user) && in_array($auth_user['User']['type'],array(1,3,4,5))){ ?>
        <li <?php
        if($activeTMenu == 'reports'){ echo 'class="active"'; } ?> >
         <?php echo $this->Html->link('<span>Reports</span><span class="caret"></span>','javascript:void(0);',array('class'=>'dropdown-toggle','data-toggle'=>'dropdown' ,'escape'=>false)); ?>
            <ul class="dropdown-menu">
               <!-- <li <?php if($activeTMenu == 'notifications'){ echo 'class="active"'; } ?> >
                ...
                <?php if($auth_user['User']['type']==1 || $auth_user['User']['type']==4 || $auth_user['User']['type']==5){?>
                        <li <?php if($activeTMenu == 'transactionReport'){ echo 'class="active"'; } ?> >
                        <?php echo $this->Html->link('<span>Transaction Report</span>',array('controller'=>'reports','action'=>'transactionReport','admin'=>true),array('escape'=>false)); ?>
                        </li>
                    <li <?php if($activeTMenu == 'transactionReport'){ echo 'class="active"'; } ?> >
                      <?php echo $this->Html->link('<span>Commision Report</span>',array('controller'=>'adminReports','action'=>'payment','admin'=>true),array('escape'=>false)); ?>
                      </li>
                      <li <?php if($activeTMenu == 'PaymentReports'){ echo 'class="active"'; } ?> >
                      <?php echo $this->Html->link('<span>Vendor Payments</span>',array('controller'=>'adminReports','action'=>'vendor_payments','admin'=>true),array('escape'=>false)); ?>
                      </li>
                <?php } ?>
        ...
        <?php if(isset($auth_user) && ($auth_user['User']['type']==1)){?>
            <li <?php if($activeTMenu == 'videoSetup'){ echo 'class="active"'; } ?> >
            <?php echo $this->Html->link('<span>Video Setup</span>',array('controller'=>'Videosetup','action'=>'index','admin'=>true),array('escape'=>false)); ?>
            </li>
        <?php } ?>
