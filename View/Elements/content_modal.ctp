<?php echo $this->Form->create('Contents', array('url' => array('controller' => 'homes', 'action' => 'save_the_content'),'id'=>'contentsForm', 'type'=>'file'));?>
  ...
  <input type="hidden" name="postAction" value="newPost" id="postAction"/>
    ...
    <ul class="listgroup liststyle-none">
        <li>
        <input name="data[Content][title]" id="content_title" maxlength="70" type="text" class="form-control textfild" placeholder="Title"  required="required" />
        </li>
<li>
